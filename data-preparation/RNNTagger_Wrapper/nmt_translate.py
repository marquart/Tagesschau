...
sys.path.insert(0,"C:\\Users\\Aron\\Documents\\WiSe_2020\\UNESCO_World_Heritage\\RNNTagger-1.2.1\\RNNTagger\\PyNMT")
sys.path.insert(0,'.')
from Data import rstrip_zeros 
from Data import Data # Data 
from NMT import NMTDecoder # PyNMT.NMT


def translate(args, data, model, inputfile):
